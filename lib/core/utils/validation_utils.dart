...
class RegexPattern {
  ...
  static String phone = r'^(?:[+0][1-9])?[0-9]{10,12}$';
...
extension StringExtentions on String {
  ...
  bool isValidPhone() {
    return RegExp(RegexPattern.phone).hasMatch(this);
  }

  /// TODO Note:~ Below not in use
  /* Future<bool> isValidUrl() async{
    return await canLaunchUrl(Uri.parse(this));
    // return RegExp(
    //     RegexPattern.url).hasMatch(this);
  }*/

  bool isValidPassword() {
    return RegExp(RegexPattern.passwordHard).hasMatch(this);
  }
}
